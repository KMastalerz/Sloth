import { AfterViewInit, Component, ElementRef, inject, model, Renderer2, viewChild } from '@angular/core';
...
@Component({
  ...
  imports: [MatDivider, MatSlideToggle, MatSlideToggleModule, SideNavigationLinkComponent],
...
export class SideNavigationComponent implements AfterViewInit {
  ...
  onThemeToggle() {
    ...
    this.renderer.setStyle(document.documentElement, 'color-scheme', this.checked() ? 'light' : 'dark');
  }
}
