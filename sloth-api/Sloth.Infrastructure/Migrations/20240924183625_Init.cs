    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebPanel", x => new { x.PageID, x.PanelID });
                    table.ForeignKey(
                        name: "FK_WebPanel_WebPage_PageID",
                        column: x => x.PageID,
                        principalTable: "WebPage",
                        principalColumn: "PageID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebSection", x => new { x.PageID, x.PanelID, x.SectionID });
                    table.ForeignKey(
                        name: "FK_WebSection_WebPanel_PageID_PanelID",
                        columns: x => new { x.PageID, x.PanelID },
                        principalTable: "WebPanel",
                        principalColumns: new[] { "PageID", "PanelID" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebControl", x => new { x.PageID, x.PanelID, x.SectionID, x.ControlID });
                    table.ForeignKey(
                        name: "FK_WebControl_WebSection_PageID_PanelID_SectionID",
                        columns: x => new { x.PageID, x.PanelID, x.SectionID },
                        principalTable: "WebSection",
                        principalColumns: new[] { "PageID", "PanelID", "SectionID" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WebControlValidation_WebControl_PageID_PanelID_SectionID_ControlID",
                        columns: x => new { x.PageID, x.PanelID, x.SectionID, x.ControlID },
                        principalTable: "WebControl",
                        principalColumns: new[] { "PageID", "PanelID", "SectionID", "ControlID" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebControlValidation_PageID_PanelID_SectionID_ControlID",
                table: "WebControlValidation",
                columns: new[] { "PageID", "PanelID", "SectionID", "ControlID" });
        }
